...
const Types = () => {
  ...
  return (
    <div
      className="w-full lg:px-20 px-5 py-[80px] grid lg:grid-cols-3 grid-cols-1
    ...
    >
      ...
      >
        ...
        <h1 className="text-4xl text-end text-white front-semibold">
          Wireless <br />
          Devices
        </h1>
        <button
          className="bg-themeYellow px-6 py-3 rounded-lg text-black
        front-semibold"
        >
          SHOW NOW
        </button>
